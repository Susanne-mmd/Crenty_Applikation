...
public class Activity_main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ibskip = (ImageButton) findViewById(R.id.ibskip);
        ...
        ibreg.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent myIntent = new Intent(view.getContext(), regmenu.class);
                startActivityForResult(myIntent, 0);
                finish();
             }});
 ...
 **/
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity_main.this);
            ...
            try {
               if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        ...
                        **/
                        Intent upanel = new Intent(getApplicationContext(), profil.class);
