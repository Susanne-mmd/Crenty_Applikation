...
public class Registered extends Activity {
	...
	//dette er JavaScpriptet for siden der bliver brugt efter du har registreret dig på vores app.
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.registered);

        //databaseHandler finder du i library som også er et JavaScript
        ...
        // dette er knappen til login siden, for at kunne logge på.
